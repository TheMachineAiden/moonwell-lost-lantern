...
test('Starfall chimes sit on a one-tile visual clearing without adding a collider',()=>{
  assert.deepEqual(JSON.parse(JSON.stringify(STARROOT_CLEARING)),{width:16,height:7,top:-1,innerWidth:10,glintOffsetY:2});
